...
# vvod = input("Введите кричалку: ")
# vvod = vvod.split()
# list_vvod_vowels = []

# for item in vvod:
#     for digit in item:
#         digit = list(filter(lambda x: x if x in 'аеёиоуыэюя' else '', item))
#     list_vvod_vowels.append(digit)
# print(list_vvod_vowels)

# print('Парам пам-пам' if len(list_vvod_vowels) == list_vvod_vowels.count(list_vvod_vowels[0]) else 'Пам парам')
...
def print_operation_table(operation, numRows=6, numColumns=6):
    for i in range(1, numRows+1):
        ...
        print()
A = print_operation_table(lambda x, y: x * y)